...
urlpatterns = [
    ...
    path('logout/', LogoutView.as_view(next_page='telles:logout_complete'), name='logout'),
    path('logout-complete/', views.logout_complete_view, name='logout_complete'),
    ...
    path('class_signup/',views.class_signup_view, name="class_signup"),
